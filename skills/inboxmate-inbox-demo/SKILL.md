...
- [ ] **5–7 threads, mixed types**: at least one revenue thread (Anfrage/Buchung with ready draft), one routine thread (Rechnungskopie/Standardfrage), one auto-archive thread (Newsletter/Werbung), one urgent/edge thread (Storno, Beschwerde). Order: most impressive first.
